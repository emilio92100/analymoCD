...
const profiles = [
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: ShieldCheck, title: 'Rien ne passe entre les mailles', text: 'Travaux lourds votés, procédures judiciaires, impayés — Verimo les repère pour que vous puissiez alerter vos clients.' },
