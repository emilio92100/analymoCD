    ...
    <footer className="bg-[#0f2d3d] text-white" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-6 pt-12 pb-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          {[{ to: '/methode', l: 'Notre méthode' }, { to: '/exemple', l: 'Voir un exemple' }, { to: '/tarifs', l: 'Tarifs' }, { to: '/guides', l: 'Guides' }, { to: '/contact', l: 'Contact' }].map(item => (
      ...
      <div className="max-w-5xl mx-auto px-6 pb-5">
        <div className="border-t border-white/10 pt-4 flex flex-col sm:flex-row justify-between gap-1">
