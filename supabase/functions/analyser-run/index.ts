...
function buildDocumentPrompt(p: string): string {
  ...
  parts.push('- eau_froide_collective : true si compteur général commun à tout l\'immeuble, false si chaque lot a son propre compteur individuel.');
