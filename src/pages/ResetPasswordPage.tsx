  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: 'linear-gradient(160deg, #f5f9fb 0%, #eaf4f8 100%)' }}>
      <div className="auth-panel" style={{ flex: 1, background: 'linear-gradient(160deg, var(--brand-teal) 0%, var(--brand-navy) 100%)', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px 64px' }}>
        <a href="/"><img src="/logo.png" alt="Verimo" style={{ height: 90, objectFit: 'contain', filter: 'brightness(0) invert(1)', marginBottom: 48 }} /></a>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          <div className="auth-mobile-logo" style={{ display: 'none', marginBottom: 32, textAlign: 'center' }}>
            <a href="/"><img src="/logo.png" alt="Verimo" style={{ height: 100, objectFit: 'contain' }} /></a>
          </div>
