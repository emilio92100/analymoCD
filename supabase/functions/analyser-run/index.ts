...
REGLES : resume = 3-4 phrases. avis_verimo = 2-3 phrases + "Cette analyse porte sur un seul document. Pour une vision complete de votre futur bien, lancez une Analyse Complete." Ne jamais inventer des donnees absentes du document - mettre null si absent. REGLE DPE : ne jamais mettre DPE A/B/C/D/E dans points_vigilance - seuls DPE F et G sont des points de vigilance, un DPE D est une bonne performance ne pas le signaler negativement. REGLE diagnostics DDT : mettre le texte complet du diagnostic dans le champ detail pour affichage en accordeon, le champ alerte = 1 phrase courte uniquement pour les points critiques.`;\n  }
