...
function buildDocumentPrompt(p: string): string {
  ...
  parts.push('');
  parts.push('PV_AG : {"document_type":"PV_AG","titre":"...","resume":"...","date_ag":null,"syndic":null,"quorum":{"presents":null,"total":null,"tantiemes_pct":null},"budget_vote":{"annee":null,"montant":null,"fonds_travaux":null},"travaux_votes":[{"label":"...","montant":null,"echeance":null}],"travaux_evoques":[{"label":"...","precision":null}],"questions_diverses":[],"procedures":[],"points_forts":[],"points_vigilance":[],"avis_verimo":"..."}');
  parts.push('');
  parts.push('APPEL_CHARGES : {"document_type":"APPEL_CHARGES","titre":"...","resume":"...","periode":null,"lot":null,"syndic":null,"montant_trimestre":null,"montant_annuel":null,"montant_mensuel":null,"decomposition":[{"poste":"...","trimestre":null,"annuel":null}],"solde_precedent":null,"impayes":false,"echeance":null,"points_forts":[],"points_vigilance":[],"avis_verimo":"..."}');
  parts.push('');
  parts.push('RCP : {"document_type":"RCP","titre":"...","resume":"...","date_reglement":null,"modificatifs":[],"usage":"habitation|mixte|commercial","total_lots":null,"parties_communes":[],"regles_usage":[],"restrictions":[],"points_forts":[],"points_vigilance":[],"avis_verimo":"..."}');
  parts.push('');
  ...
  parts.push('');
  parts.push('CARNET_ENTRETIEN : {"document_type":"CARNET_ENTRETIEN","titre":"...","resume":"...","syndic":null,"date_maj":null,"contrats":[{"equipement":"...","prestataire":null,"echeance":null}],"travaux_realises":[{"annee":null,"label":"...","montant":null}],"diagnostics_mentionnes":[{"type":"...","date":null,"statut":null}],"points_forts":[],"points_vigilance":[],"avis_verimo":"..."}');
  parts.push('');
  parts.push('PRE_ETAT_DATE : {"document_type":"PRE_ETAT_DATE","titre":"...","resume":"...","date":null,"lot":null,"syndic":null,"impayes_vendeur":0,"fonds_travaux_alur":null,"travaux_charge_vendeur":[{"label":"...","montant":null}],"procedures_contre_vendeur":[],"situation_copro":[],"points_forts":[],"points_vigilance":[],"avis_verimo":"..."}');
  parts.push('');
  parts.push('ETAT_DATE : {"document_type":"ETAT_DATE","titre":"...","resume":"...","date":null,"lot":null,"syndic":null,"solde_net":null,"solde_sens":"acheteur|vendeur","fonds_travaux_alur":null,"decomposition":[{"poste":"...","montant":null,"sens":"acheteur_recoit|vendeur_doit"}],"travaux_consignes":[{"label":"...","montant":null}],"points_forts":[],"points_vigilance":[],"avis_verimo":"..."}');
  parts.push('');
