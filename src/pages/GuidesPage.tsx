...
const cats: Cat[] = [
  { id: "copropriete", icon: "🏢", label: "Copropriété", color: "#2a7d9c", subs: [
    ...
    { title: "Finances & Charges", articles: [
      ...
      { title: "Pré-état daté : ce qu'il contient et pourquoi le demander avant le compromis", slug: "pre-etat-date-avant-compromis", description: "Avant même de signer, ce document vous donne une première photo financière de la copropriété.", docInfo: { emoji: "💡", label: "Pré-état daté", definition: "Document d'information fourni par le syndic avant le compromis. Il donne un aperçu de la situation financière du lot et de la copropriété, sans la valeur juridique de l'état daté officiel." } },
