...
const categories = [
  ...
  },
  {
    ...
    info: [
      ...
      { l: 'Mesurage loi Carrez : vos recours', tip: "Si un nouveau mesurage établit que la surface réelle est inférieure de plus de 5 % à celle mentionnée dans l'acte authentique, l'acquéreur peut agir en diminution du prix (article 46 de la loi du 10 juillet 1965). Trois points souvent mal compris : la réduction est proportionnelle à la totalité de l'écart, pas à sa seule part au-delà de 5 % — 100 m² annoncés pour 93 m² réels donnent 7 % de réduction, pas 2 % ; l'action doit être engagée en justice dans un délai d'un an à compter de la signature de l'acte authentique, un délai de forclusion qui ne se suspend ni ne s'interrompt ; et elle n'est ouverte qu'à l'acquéreur, le vendeur ne pouvant réclamer aucun supplément si la surface s'avère supérieure." },
    ],
  },
  {
