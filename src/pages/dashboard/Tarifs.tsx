...
export default function Tarifs() {
  ...
  const plans: { id: string; label: string; price: string; priceNum: number; desc: string; creditLabel: string; creditType: keyof Credits; color: string; icon: React.ElementType; popular?: boolean; badge?: string; details: string[] }[] = [
    { id: 'document', label: 'Analyse Document', price: '4,90€', priceNum: 4.90, desc: 'Idéal pour lever un doute sur un document précis.', creditLabel: '1 crédit simple', creditType: 'document', color: '#2a7d9c', icon: FileText, details: ["1 fichier analysé en profondeur", "PV d'AG, règlement, diagnostic ou appel de charges", 'Résumé clair + points forts + vigilances', 'Rapport PDF téléchargeable', 'Résultat en moins de 2 minutes'] },
    { id: 'complete', label: 'Analyse Complète', price: '19,90€', priceNum: 19.90, desc: "Audit global d'un bien avec score et recommandation.", creditLabel: '1 crédit complet', creditType: 'complete', color: '#0f2d3d', icon: ShieldCheck, popular: true, details: ['Documents illimités pour un seul bien', 'Score global noté /20', 'Recommandation : Acheter / Négocier / Risqué', 'Estimation des risques financiers', 'Avis Verimo complet', 'Rapport PDF téléchargeable', 'Résultat en moins de 2 minutes'] },
    { id: 'pack2', label: 'Pack 2 Biens', price: '29,90€', priceNum: 29.90, desc: 'Comparez 2 biens côte à côte. 14,95€ / bien.', creditLabel: '2 crédits complets', creditType: 'complete', color: '#1a5068', icon: GitCompare, badge: '−25%', details: ['2 analyses complètes incluses', 'Comparaison côte à côte des 2 biens', 'Verdict Verimo : quel bien choisir', '14,95€ / analyse au lieu de 19,90€', 'Rapport PDF pour chaque bien'] },
    { id: 'pack3', label: 'Pack 3 Biens', price: '39,90€', priceNum: 39.90, desc: 'Le meilleur rapport qualité/prix. 13,30€ / bien.', creditLabel: '3 crédits complets', creditType: 'complete', color: '#1a5068', icon: BarChart2, badge: '−33%', details: ['3 analyses complètes incluses', 'Comparaison des 3 biens', 'Classement final Verimo', 'Recommandation définitive', '13,30€ / analyse au lieu de 19,90€', 'Rapport PDF pour chaque bien'] },
  ];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 28, maxWidth: 740, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 10 }}>
        {[{ icon: '🔒', title: 'Stripe sécurisé', sub: 'Paiement chiffré' }, { icon: '♾️', title: 'Sans expiration', sub: 'Utilisez quand vous voulez' }, { icon: '⚡', title: '< 2 minutes', sub: 'Rapport immédiat' }, { icon: '🗑️', title: 'Données supprimées', sub: 'Après chaque analyse' }].map(g => (
