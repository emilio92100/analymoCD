...
function buildDocumentPrompt(p: string): string {
  ...
  parts.push('- finances.frais_notaire_estimes_verimo : CALCUL automatique. Si bien ancien (>5 ans ou pas neuf/VEFA explicite) : frais = prix_total_acte × 0.075 (7.5%). Si bien neuf ou VEFA explicite : frais = prix_total_acte × 0.03 (3%). Arrondir a la centaine. Mettre frais_notaire_pct_verimo = 7.5 ou 3.0. C est une ESTIMATION Verimo, pas une donnee du document.');
