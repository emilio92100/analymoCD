...
export default function Tarifs() {
  ...
  const plans: { id: string; label: string; price: string; priceNum: number; desc: string; creditLabel: string; creditType: keyof Credits; color: string; icon: React.ElementType; popular?: boolean; badge?: string; details: string[] }[] = [
    { id: 'document', label: 'Analyse Document', price: '4,90€', priceNum: 4.90, desc: 'Idéal pour lever un doute sur un document précis.', creditLabel: '1 crédit simple', creditType: 'document', color: '#2a7d9c', icon: FileText, details: ["1 fichier analysé en profondeur", "PV d'AG, règlement, diagnostic ou appel de charges", 'Résumé clair + points forts + vigilances', 'Rapport PDF téléchargeable', 'Résultat en moins de 30 secondes*'] },
    { id: 'complete', label: 'Analyse Complète', price: '19,90€', priceNum: 19.90, desc: "Audit global d'un bien avec score et recommandation.", creditLabel: '1 crédit complet', creditType: 'complete', color: '#0f2d3d', icon: ShieldCheck, popular: true, details: ["Jusqu'à 15 documents pour un seul bien", 'Score global noté /20', 'Recommandation : Acheter / Négocier / Risqué', 'Estimation des risques financiers', 'Avis Verimo complet', 'Compléter le dossier sous 7 jours', 'Rapport PDF téléchargeable', 'Résultat en moins de 2 minutes*'] },
