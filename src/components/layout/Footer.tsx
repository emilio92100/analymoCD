    ...
    <footer className="bg-[#0f2d3d] text-white" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-5">
        <div className="border-t border-white/10 pt-4 flex flex-col gap-2">
          <p className="text-xs text-white/25 leading-relaxed" data-nosnippet="">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-1">
            ...
            <p className="text-xs text-white/20" data-nosnippet="">Outil d'aide à la décision — pas un cabinet de conseil.</p>
          </div>
        </div>
      </div>
    </footer>
