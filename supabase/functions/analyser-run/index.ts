...
- RÈGLE CRITIQUE — VOTES EN DEUX TOURS (droit français copropriété) : En copropriété française, certaines résolutions nécessitent la majorité art. 25 (majorité de TOUS les copropriétaires) au 1er tour. Si cette majorité n est pas atteinte MAIS que la résolution a recueilli au moins 1/3 des voix, la loi impose de passer IMMÉDIATEMENT au 2ème tour à la majorité art. 24 (majorité des présents/représentés). CE N EST PAS UN REFUS. Si le 2ème tour adopte la résolution → la résolution EST ADOPTÉE à part entière. Exemples : fonds travaux ALUR, ravalement, toiture, ascenseur, contrat syndic... Ne JAMAIS qualifier de "refusé" ou "rejeté" une résolution qui a été adoptée au 2ème tour. Un vrai refus = résolution explicitement rejetée sans second tour possible, ou 2ème tour également rejeté. Appliquer cette règle à TOUTES les résolutions d AG, pas seulement aux fonds de travaux.');
